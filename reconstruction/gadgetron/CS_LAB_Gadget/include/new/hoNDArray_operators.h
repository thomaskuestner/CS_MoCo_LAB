...
namespace Gadgetron{
   ...
   */
  template<class T> EXPORTCSLAB hoNDArray<T>& operator+= (hoNDArray<T> &x, const hoNDArray<T> &y);
   ...
   */
  template<class T> EXPORTCSLAB hoNDArray<T>& operator+= (hoNDArray<T> &x, const T &y);
   ...
   * If x contains further dimensions the operator is batched across those dimensions.
   */
  template<class T> EXPORTCSLAB hoNDArray< std::complex<T> >& operator+= (hoNDArray< std::complex<T> > &x, const hoNDArray<T> &y);
   ...
   * @param[in] y Input scalar.
   */
  template<class T> EXPORTCSLAB hoNDArray< std::complex<T> >& operator+= (hoNDArray< std::complex<T> >&x, const T &y);
   ...
   * If x contains further dimensions the operator is batched across those dimensions.
   */
  template<class T> EXPORTCSLAB hoNDArray< complext<T> >& operator+= (hoNDArray< complext<T> > &x, const hoNDArray<T> &y);
   ...
   * @param[in] y Input scalar.
   */
  template<class T> EXPORTCSLAB hoNDArray< complext<T> >& operator+= (hoNDArray< complext<T> >&x, const T &y);
