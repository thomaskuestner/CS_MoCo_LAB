...
template EXPORTCSLAB void potrf(hoNDArray<float>& A, char uplo);
template EXPORTCSLAB void potrf(hoNDArray<double>& A, char uplo);
template EXPORTCSLAB void potrf(hoNDArray< std::complex<float> >& A, char uplo);
template EXPORTCSLAB void potrf(hoNDArray< complext<float> >& A, char uplo);
template EXPORTCSLAB void potrf(hoNDArray< std::complex<double> >& A, char uplo);
template EXPORTCSLAB void potrf(hoNDArray< complext<double> >& A, char uplo);
...
template EXPORTCSLAB void heev(hoNDArray<float>& A, hoNDArray<float>& eigenValue);
template EXPORTCSLAB void heev(hoNDArray<double>& A, hoNDArray<double>& eigenValue);
template EXPORTCSLAB void heev(hoNDArray< std::complex<float> >& A, hoNDArray<float>& eigenValue);
template EXPORTCSLAB void heev(hoNDArray< complext<float> >& A, hoNDArray<float>& eigenValue);
template EXPORTCSLAB void heev(hoNDArray< std::complex<double> >& A, hoNDArray<double>& eigenValue);
template EXPORTCSLAB void heev(hoNDArray< complext<double> >& A, hoNDArray<double>& eigenValue);
...
template EXPORTCSLAB void heev(hoNDArray< std::complex<float> >& A, hoNDArray< std::complex<float> >& eigenValue);
template EXPORTCSLAB void heev(hoNDArray< std::complex<double> >& A, hoNDArray< std::complex<double> >& eigenValue);
...
template EXPORTCSLAB void potri(hoNDArray<float>& A);
template EXPORTCSLAB void potri(hoNDArray<double>& A);
template EXPORTCSLAB void potri(hoNDArray< std::complex<float> >& A);
template EXPORTCSLAB void potri(hoNDArray< complext<float> >& A);
template EXPORTCSLAB void potri(hoNDArray< std::complex<double> >& A);
template EXPORTCSLAB void potri(hoNDArray< complext<double> >& A);
...
template EXPORTCSLAB void trtri(hoNDArray<float>& A, char uplo);
template EXPORTCSLAB void trtri(hoNDArray<double>& A, char uplo);
template EXPORTCSLAB void trtri(hoNDArray< std::complex<float> >& A, char uplo);
template EXPORTCSLAB void trtri(hoNDArray< complext<float> >& A, char uplo);
template EXPORTCSLAB void trtri(hoNDArray< std::complex<double> >& A, char uplo);
template EXPORTCSLAB void trtri(hoNDArray< complext<double> >& A, char uplo);
...
template EXPORTCSLAB void posv(hoNDArray<float>& A, hoNDArray<float>& b);
template EXPORTCSLAB void posv(hoNDArray<double>& A, hoNDArray<double>& b);
template EXPORTCSLAB void posv(hoNDArray< std::complex<float> >& A, hoNDArray< std::complex<float> >& b);
template EXPORTCSLAB void posv(hoNDArray< complext<float> >& A, hoNDArray< complext<float> >& b);
template EXPORTCSLAB void posv(hoNDArray< std::complex<double> >& A, hoNDArray< std::complex<double> >& b);
template EXPORTCSLAB void posv(hoNDArray< complext<double> >& A, hoNDArray< complext<double> >& b);
...
template EXPORTCSLAB void getrf(hoNDArray<float>& A, hoNDArray<lapack_int>& ipiv);
template EXPORTCSLAB void getrf(hoNDArray<double>& A, hoNDArray<lapack_int>& ipiv);
template EXPORTCSLAB void getrf(hoNDArray< std::complex<float> >& A, hoNDArray<lapack_int>& ipiv);
template EXPORTCSLAB void getrf(hoNDArray< complext<float> >& A, hoNDArray<lapack_int>& ipiv);
template EXPORTCSLAB void getrf(hoNDArray< std::complex<double> >& A, hoNDArray<lapack_int>& ipiv);
template EXPORTCSLAB void getrf(hoNDArray< complext<double> >& A, hoNDArray<lapack_int>& ipiv);
...
template EXPORTCSLAB void getri(hoNDArray<float>& A);
template EXPORTCSLAB void getri(hoNDArray<double>& A);
template EXPORTCSLAB void getri(hoNDArray< std::complex<float> >& A);
template EXPORTCSLAB void getri(hoNDArray< complext<float> >& A);
template EXPORTCSLAB void getri(hoNDArray< std::complex<double> >& A);
template EXPORTCSLAB void getri(hoNDArray< complext<double> >& A);
...
//}
//
//template EXPORTCSLAB void SolveLinearSystem_Tikhonov(hoNDArray<float>& A, hoNDArray<float>& b, hoNDArray<float>& x, double lamda);
//template EXPORTCSLAB void SolveLinearSystem_Tikhonov(hoNDArray<double>& A, hoNDArray<double>& b, hoNDArray<double>& x, double lamda);
//template EXPORTCSLAB void SolveLinearSystem_Tikhonov(hoNDArray< std::complex<float> >& A, hoNDArray< std::complex<float> >& b, hoNDArray< std::complex<float> >& x, double lamda);
//template EXPORTCSLAB void SolveLinearSystem_Tikhonov(hoNDArray< complext<float> >& A, hoNDArray< complext<float> >& b, hoNDArray< complext<float> >& x, double lamda);
//template EXPORTCSLAB void SolveLinearSystem_Tikhonov(hoNDArray< std::complex<double> >& A, hoNDArray< std::complex<double> >& b, hoNDArray< std::complex<double> >& x, double lamda);
//template EXPORTCSLAB void SolveLinearSystem_Tikhonov(hoNDArray< complext<double> >& A, hoNDArray< complext<double> >& b, hoNDArray< complext<double> >& x, double lamda);
