...
template<typename T> hoNDFFT_CS<T>* hoNDFFT_CS<T>::instance()
{
	if (!instance_) {
		instance_ = new hoNDFFT_CS<T>();
	}

	return instance_;
}

template<class T> hoNDFFT_CS<T>* hoNDFFT_CS<T>::instance_ = NULL;

// with scrambling control
template<class T> void hoNDFFT_CS<T>::fft_int(hoNDArray<ComplexType> *input, size_t dim_to_transform, int sign, bool bScrambling)
{
	if (sign != -1 && sign != 1) {
		return;
	}

	if (dim_to_transform >= input->get_number_of_dimensions()) {
		return;
	}
	...
	if (fft_storage == 0) {
		GERROR("Failed to allocate buffer for FFT\n");
		return;
	}
	...
	if (fft_plan == 0) {
		...
		GERROR("Failed to create plan for FFT\n");
		return;
	}
...
template<class T> void hoNDFFT_CS<T>::fft_int(hoNDArray<ComplexType> *input, size_t dim_to_transform, int sign)
{
	if (sign != -1 && sign != 1) {
		return;
	}
...
template<> void hoNDFFT_CS<float>::set_function_pointers()
{
...
template<typename T>
inline size_t hoNDFFT_CS<T>::fftshiftPivot(size_t x)
{
	return (size_t)(ceil(x*0.5));
}

template<typename T>
inline size_t hoNDFFT_CS<T>::ifftshiftPivot(size_t x)
{
	return (size_t)(floor(x*0.5));
}

template<typename T>
inline bool hoNDFFT_CS<T>::fftshift1D(const ComplexType *a, ComplexType *r, size_t x, size_t pivot)
{
	try {
		memcpy(r, a+pivot, sizeof(ComplexType)*(x-pivot));
		memcpy(r+x-pivot, a, sizeof(ComplexType)*pivot);
	} catch (...) {
		GADGET_ERROR_MSG("Errors in hoNDFFT_CS<T>::fftshift1D(const ComplexType* a, ComplexType* r, size_t x, size_t pivot) ...");
		return false;
	}
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifftshift1D(const ComplexType *a, ComplexType *r, size_t x, size_t pivot)
{
	return fftshift1D(a, r, x, pivot);
}

template<typename T>
bool hoNDFFT_CS<T>::fftshiftPivot1D(ComplexType *a, size_t x, size_t n, size_t pivot)
{
	try {
		long long counter;
		...
		GADGET_ERROR_MSG("Errors in hoNDFFT_CS<T>::fftshiftPivot1D(ComplexType* a, size_t x, size_t n, size_t pivot) ...");
		return false;
	}
...
template<typename T>
bool hoNDFFT_CS<T>::fftshiftPivot1D(const ComplexType *a, ComplexType *r, size_t x, size_t n, size_t pivot)
{
	try {
		long long counter;
		...
		GADGET_ERROR_MSG("Errors in hoNDFFT_CS<T>::fftshiftPivot1D(const ComplexType* a, ComplexType* r, size_t x, size_t n, size_t pivot) ...");
		return false;
	}
...
template<typename T>
bool hoNDFFT_CS<T>::fftshift1D(hoNDArray<ComplexType> &a)
{
	try {
		...
		GADGET_ERROR_MSG("Errors in hoNDFFT_CS<T>::fftshift1D(hoNDArray< ComplexType >& a) ...");
		return false;
	}
...
template<typename T>
bool hoNDFFT_CS<T>::fftshift1D(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r)
{
	try {
		...
		GADGET_ERROR_MSG("Errors in hoNDFFT_CS<T>::fftshift1D(const hoNDArray< ComplexType >& a, hoNDArray< ComplexType >& r) ...");
		return false;
	}
...
template<typename T>
bool hoNDFFT_CS<T>::ifftshift1D(hoNDArray<ComplexType> &a)
{
	try {
		size_t x = a.get_size(0);
		...
		GADGET_ERROR_MSG("Errors in hoNDFFT_CS<T>::ifftshift1D(hoNDArray< ComplexType >& a) ...");
		return false;
	}
...
template<typename T>
bool hoNDFFT_CS<T>::ifftshift1D(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r)
{
	try {
		if (!r.dimensions_equal(&a)) {
			r = a;
		...
		GADGET_ERROR_MSG("Errors in hoNDFFT_CS<T>::ifftshift1D(const hoNDArray< ComplexType >& a, hoNDArray< ComplexType >& r) ...");
		return false;
	}
...
template<typename T>
bool hoNDFFT_CS<T>::fftshiftPivot2D(const ComplexType *a, ComplexType *r, size_t x, size_t y, size_t n, size_t pivotx, size_t pivoty)
{
	try {
		...
		GADGET_ERROR_MSG("Errors in hoNDFFT_CS<T>::fftshiftPivot2D(const ComplexType* a, ComplexType* r, size_t x, size_t y, size_t n, size_t pivotx, size_t pivoty) ...");
		return false;
	}
...
template<typename T>
bool hoNDFFT_CS<T>::fftshiftPivot2D(ComplexType *a, size_t x, size_t y, size_t n, size_t pivotx, size_t pivoty)
{
	try {
		GADGET_CHECK_RETURN_FALSE(a!=NULL);
		...
		GADGET_ERROR_MSG("Errors in hoNDFFT_CS<T>::fftshiftPivot2D(ComplexType* a, size_t x, size_t y, size_t n, size_t pivotx, size_t pivoty) ...");
		return false;
	}
...
template<typename T>
inline bool hoNDFFT_CS<T>::fftshift2D(const ComplexType *a, ComplexType *r, size_t x, size_t y, size_t n)
{
	try {
		GADGET_CHECK_RETURN_FALSE(a!=NULL);
		GADGET_CHECK_RETURN_FALSE(r!=NULL);
		...
		GADGET_ERROR_MSG("Errors in hoNDFFT_CS<T>::fftshift2D(const ComplexType* a, ComplexType* r, size_t x, size_t y, size_t n) ...");
		return false;
	}
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifftshift2D(const ComplexType *a, ComplexType *r, size_t x, size_t y, size_t n)
{
	try {
		GADGET_CHECK_RETURN_FALSE(a!=NULL);
		GADGET_CHECK_RETURN_FALSE(r!=NULL);
		...
		GADGET_ERROR_MSG("Errors in hoNDFFT_CS<T>::ifftshift2D(const ComplexType* a, ComplexType* r, size_t x, size_t y, size_t n) ...");
		return false;
	}
...
template<typename T>
inline bool hoNDFFT_CS<T>::fftshift2D(ComplexType *a, size_t x, size_t y, size_t n)
{
	try {
		GADGET_CHECK_RETURN_FALSE(a!=NULL);
		...
		GADGET_ERROR_MSG("Errors in hoNDFFT_CS<T>::fftshift2D(ComplexType* a, size_t x, size_t y, size_t n) ...");
		return false;
	}
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifftshift2D(ComplexType *a, size_t x, size_t y, size_t n)
{
	try {
		GADGET_CHECK_RETURN_FALSE(a!=NULL);
		...
		GADGET_ERROR_MSG("Errors in hoNDFFT_CS<T>::ifftshift2D(ComplexType* a, size_t x, size_t y, size_t n) ...");
		return false;
	}
...
template<typename T>
inline bool hoNDFFT_CS<T>::fftshift2D(hoNDArray<ComplexType> &a)
{
...
template<typename T>
inline bool hoNDFFT_CS<T>::fftshift2D(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r)
{
	if (!r.dimensions_equal(&a)) {
		r = a;
	}
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifftshift2D(hoNDArray<ComplexType> &a)
{
	size_t n = a.get_number_of_elements()/(a.get_size(0)*a.get_size(1));
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifftshift2D(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r)
{
	if (!r.dimensions_equal(&a)) {
		r = a;
	}
...
template<typename T>
bool hoNDFFT_CS<T>::fftshiftPivot3D(const ComplexType *a, ComplexType *r, size_t x, size_t y, size_t z, size_t n, size_t pivotx, size_t pivoty, size_t pivotz)
{
	try {
		GADGET_CHECK_RETURN_FALSE(a!=NULL);
		GADGET_CHECK_RETURN_FALSE(r!=NULL);
		...
		GERROR("Errors in hoNDFFT_CS<T>::fftshiftPivot3D(const ComplexType* a, ComplexType* r, size_t x, size_t y, size_t z, size_t n, unsigned pivotx, unsigned pivoty, unsigned pivotz) ...\n");
		return false;
	}
...
template<typename T>
bool hoNDFFT_CS<T>::fftshiftPivot3D(ComplexType *a, size_t x, size_t y, size_t z, size_t n, size_t pivotx, size_t pivoty, size_t pivotz)
{
	try {
		GADGET_CHECK_RETURN_FALSE(a!=NULL);
		...
		GERROR("Errors in hoNDFFT_CS<T>::fftshiftPivot3D(ComplexType* a, size_t x, size_t y, size_t z, size_t n, unsigned pivotx, unsigned pivoty, unsigned pivotz) ...\n");
		return false;
	}
...
template<typename T>
inline bool hoNDFFT_CS<T>::fftshift3D(const ComplexType *a, ComplexType *r, size_t x, size_t y, size_t z, size_t n)
{
	try {
		GADGET_CHECK_RETURN_FALSE(a!=NULL);
		GADGET_CHECK_RETURN_FALSE(r!=NULL);
		...
		GERROR("Errors in hoNDFFT_CS<T>::fftshift3D(const ComplexType* a, ComplexType* r, size_t x, size_t y, size_t z, size_t n) ...\n");
		return false;
	}
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifftshift3D(const ComplexType *a, ComplexType *r, size_t x, size_t y, size_t z, size_t n)
{
	try {
		GADGET_CHECK_RETURN_FALSE(a!=NULL);
		GADGET_CHECK_RETURN_FALSE(r!=NULL);
		...
		GERROR("Errors in hoNDFFT_CS<T>::ifftshift3D(const ComplexType* a, ComplexType* r, size_t x, size_t y, size_t z, size_t n) ...\n");
		return false;
	}
...
template<typename T>
inline bool hoNDFFT_CS<T>::fftshift3D(ComplexType *a, size_t x, size_t y, size_t z, size_t n)
{
	try {
		GADGET_CHECK_RETURN_FALSE(a!=NULL);
		...
		GERROR("Errors in hoNDFFT_CS<T>::fftshift3D(ComplexType* a, size_t x, size_t y, size_t z, size_t n) ...\n");
		return false;
	}
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifftshift3D(ComplexType *a, size_t x, size_t y, size_t z, size_t n)
{
	try {
		GADGET_CHECK_RETURN_FALSE(a!=NULL);
		...
		GERROR("Errors in hoNDFFT_CS<T>::ifftshift3D(ComplexType* a, size_t x, size_t y, size_t z, size_t n) ...\n");
		return false;
	}
...
template<typename T>
inline bool hoNDFFT_CS<T>::fftshift3D(hoNDArray<ComplexType> &a)
{
...
template<typename T>
inline bool hoNDFFT_CS<T>::fftshift3D(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r)
{
	if (!r.dimensions_equal(&a)) {
		r = a;
	}
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifftshift3D(hoNDArray<ComplexType> &a)
{
	size_t n = a.get_number_of_elements()/(a.get_size(0)*a.get_size(1)*a.get_size(2));
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifftshift3D(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r)
{
	if (!r.dimensions_equal(&a)) {
		r = a;
	}
...
template<typename T>
inline bool hoNDFFT_CS<T>::fft1(hoNDArray<ComplexType> &a)
{
	return fft1(a, true);
}

template<typename T>
inline bool hoNDFFT_CS<T>::ifft1(hoNDArray<ComplexType> &a)
{
	return fft1(a, false);
}

template<typename T>
inline bool hoNDFFT_CS<T>::fft1(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r)
{
	if (!r.dimensions_equal(&a)) {
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifft1(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r)
{
	if (!r.dimensions_equal(&a)) {
		r.create(a.get_dimensions());
	}
...
template<typename T>
inline bool hoNDFFT_CS<T>::fft1c(hoNDArray<ComplexType> &a)
{
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifft1c(hoNDArray<ComplexType> &a)
{
	GADGET_CHECK_RETURN_FALSE(ifftshift1D(a));
...
template<typename T>
inline bool hoNDFFT_CS<T>::fft1c(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r)
{
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifft1c(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r)
{
	GADGET_CHECK_RETURN_FALSE(ifftshift1D(a, r));
...
template<typename T>
inline bool hoNDFFT_CS<T>::fft1c(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r, hoNDArray<ComplexType> &buf)
{
	GADGET_CHECK_RETURN_FALSE(ifftshift1D(a, r));
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifft1c(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r, hoNDArray<ComplexType> &buf)
{
	GADGET_CHECK_RETURN_FALSE(ifftshift1D(a, r));
...
template<typename T>
inline bool hoNDFFT_CS<T>::fft2(hoNDArray<ComplexType> &a)
{
	return fft2(a, true);
}

template<typename T>
inline bool hoNDFFT_CS<T>::ifft2(hoNDArray<ComplexType> &a)
{
	return fft2(a, false);
}

template<typename T> 
inline bool hoNDFFT_CS<T>::fft2(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r)
{
	//r = a;
	//return fft2(r);
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifft2(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r)
{
	/*r = a;
	return ifft2(r);*/
...
template<typename T>
inline bool hoNDFFT_CS<T>::fft2c(hoNDArray<ComplexType> &a)
{
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifft2c(hoNDArray<ComplexType> &a)
{
	GADGET_CHECK_RETURN_FALSE(ifftshift2D(a));
...
template<typename T>
inline bool hoNDFFT_CS<T>::fft2c(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r)
{
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifft2c(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r)
{
	GADGET_CHECK_RETURN_FALSE(ifftshift2D(a, r));
...
template<typename T>
inline bool hoNDFFT_CS<T>::fft2c(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r, hoNDArray<ComplexType> &buf)
{
	GADGET_CHECK_RETURN_FALSE(ifftshift2D(a, r));
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifft2c(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r, hoNDArray<ComplexType> &buf)
{
	GADGET_CHECK_RETURN_FALSE(ifftshift2D(a, r));
...
template<typename T>
inline bool hoNDFFT_CS<T>::fft3(hoNDArray<ComplexType> &a)
{
	return fft3(a, true);
}

template<typename T>
inline bool hoNDFFT_CS<T>::ifft3(hoNDArray<ComplexType> &a)
{
	return fft3(a, false);
}

template<typename T>
inline bool hoNDFFT_CS<T>::fft3(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r)
{
	/*r = a;
	return fft3(r);*/
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifft3(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r)
{
	/*r = a;
	return ifft3(r);*/
...
template<typename T>
inline bool hoNDFFT_CS<T>::fft3c(hoNDArray<ComplexType> &a)
{
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifft3c(hoNDArray<ComplexType> &a)
{
	GADGET_CHECK_RETURN_FALSE(ifftshift3D(a));
...
template<typename T>
inline bool hoNDFFT_CS<T>::fft3c(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r)
{
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifft3c(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r)
{
	GADGET_CHECK_RETURN_FALSE(ifftshift3D(a, r));
...
template<typename T>
inline bool hoNDFFT_CS<T>::fft3c(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r, hoNDArray<ComplexType> &buf)
{
	GADGET_CHECK_RETURN_FALSE(ifftshift3D(a, r));
...
template<typename T>
inline bool hoNDFFT_CS<T>::ifft3c(const hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r, hoNDArray<ComplexType> &buf)
{
	GADGET_CHECK_RETURN_FALSE(ifftshift3D(a, r));
...
#ifdef USE_MKL
template<typename T>
bool hoNDFFT_CS<T>::configureFFTHandle(long long NDim, MKL_LONG *dim, DFTI_CONFIG_VALUE fftPresion, size_t n, DFTI_DESCRIPTOR_HANDLE& handle)
{
	long long ii;
	MKL_LONG res;
...
template<typename T>
bool hoNDFFT_CS<T>::configureFFTHandleOutOfPlace(long long NDim, MKL_LONG *dim, DFTI_CONFIG_VALUE fftPresion, size_t n, DFTI_DESCRIPTOR_HANDLE &handle)
{
	long long ii;
	MKL_LONG res;
...
template<typename T>
bool hoNDFFT_CS<T>::fft1(hoNDArray<ComplexType> &a, bool forward)
{
	...
	if (typeid(T) == typeid(float)) {
		...
		GERROR("hoNDFFT_CS<T>::fft1(hoNDArray< ComplexType >& a), only float and double are supported ...\n");
		return false;
	}
...
template<typename T>
bool hoNDFFT_CS<T>::fft1(hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r, bool forward)
{
	size_t n = a.get_number_of_elements()/a.get_size(0);
	MKL_LONG dim = a.get_size(0);
	...
	if (typeid(T) == typeid(float)) {
		...
		GERROR("hoNDFFT_CS<T>::fft1(hoNDArray< ComplexType >& a, hoNDArray< ComplexType >& r), only float and double are supported ...\n");
		return false;
	}
...
template<typename T>
bool hoNDFFT_CS<T>::fft2(hoNDArray<ComplexType> &a, bool forward)
{
	size_t n = a.get_number_of_elements()/(a.get_size(0)*a.get_size(1));
	MKL_LONG dim[2];
	dim[0] = a.get_size(1);
	...
	if (typeid(T) == typeid(float)) {
		...
		GERROR("hoNDFFT_CS<T>::fft2(hoNDArray< ComplexType >& a), only float and double are supported ...\n");
		return false;
	}
...
template<typename T>
bool hoNDFFT_CS<T>::fft2(hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r, bool forward)
{
	size_t n = a.get_number_of_elements()/(a.get_size(0)*a.get_size(1));
	MKL_LONG dim[2];
	dim[0] = a.get_size(1);
...
template<typename T>
bool hoNDFFT_CS<T>::fft3(hoNDArray<ComplexType> &a, bool forward)
{
	size_t n = a.get_number_of_elements()/(a.get_size(0)*a.get_size(1)*a.get_size(2));
	...
	if (typeid(T) == typeid(float)) {
		...
		GERROR("hoNDFFT_CS<T>::fft3(hoNDArray< ComplexType >& a), only float and double are supported ...\n");
		return false;
	}
...
template<typename T>
bool hoNDFFT_CS<T>::fft3(hoNDArray<ComplexType> &a, hoNDArray<ComplexType> &r, bool forward)
{
	size_t n = a.get_number_of_elements()/(a.get_size(0)*a.get_size(1)*a.get_size(2));
	...
	if (typeid(T) == typeid(float)) {
		...
		GERROR("hoNDFFT_CS<T>::fft3(a, r), only float and double are supported ...\n");
		return false;
	}
