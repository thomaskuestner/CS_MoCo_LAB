...
namespace Gadgetron{
...

    {
        ...
        if (!instance_) instance_ = new hoNDFFT_CS<T>();
...
#pragma omp parallel for private(tt) shared(a, r, x, y, z, n, pivotx, pivoty, pivotz) if (n>1)
...

        {
            ...
            GADGET_ERROR_MSG("Errors in hoNDFFT_CS<T>::fftshiftPivot3D(const ComplexType* a, ComplexType* r, size_t x, size_t y, size_t z, size_t n, unsigned pivotx, unsigned pivoty,  unsigned pivotz) ...");
...
#pragma omp for
...

        {
            ...
            GADGET_ERROR_MSG("Errors in hoNDFFT_CS<T>::fftshiftPivot3D(ComplexType* a, size_t x, size_t y, size_t z, size_t n, unsigned pivotx, unsigned pivoty,  unsigned pivotz) ...");
...

    {
...

        {
            ...
            GADGET_ERROR_MSG("Errors in hoNDFFT_CS<T>::fftshift3D(const ComplexType* a, ComplexType* r, size_t x, size_t y, size_t z, size_t n) ...");
...

    {
...

        {
            ...
            GADGET_ERROR_MSG("Errors in hoNDFFT_CS<T>::ifftshift3D(const ComplexType* a, ComplexType* r, size_t x, size_t y, size_t z, size_t n) ...");
...

    {
...

        {
            ...
            GADGET_ERROR_MSG("Errors in hoNDFFT_CS<T>::fftshift3D(ComplexType* a, size_t x, size_t y, size_t z, size_t n) ...");
...

    {
...

        {
            ...
            GADGET_ERROR_MSG("Errors in hoNDFFT_CS<T>::ifftshift3D(ComplexType* a, size_t x, size_t y, size_t z, size_t n) ...");
...

    {
...

        {
            ...
            GADGET_ERROR_MSG("hoNDFFT_CS<T>::fft1(hoNDArray< ComplexType >& a), only float and double are supported ... ");
...

    {
...

        {
            ...
            GADGET_ERROR_MSG("hoNDFFT_CS<T>::fft1(hoNDArray< ComplexType >& a, hoNDArray< ComplexType >& r), only float and double are supported ... ");
...

    {
...

        {
            ...
            GADGET_ERROR_MSG("hoNDFFT_CS<T>::fft2(hoNDArray< ComplexType >& a), only float and double are supported ... ");
...

    {
...

        {
            ...
            GADGET_ERROR_MSG("hoNDFFT_CS<T>::fft3(hoNDArray< ComplexType >& a), only float and double are supported ... ");
...

    {
...

        {
            ...
            GADGET_ERROR_MSG("hoNDFFT_CS<T>::fft3(a, r), only float and double are supported ... ");
