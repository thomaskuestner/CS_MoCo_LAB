...
int ImageSaveHDFGadgetFLOAT::process_config(ACE_Message_Block* mb)
{
...
inline bool ImageSaveHDFGadgetFLOAT::dirExists(const std::string& dirName_in)
{
...
std::string ImageSaveHDFGadgetFLOAT::get_date_time_string()
{
	time_t rawtime;
	struct tm *timeinfo;
	time (&rawtime);
