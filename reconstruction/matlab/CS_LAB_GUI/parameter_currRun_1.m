...
% 2D | 3D (just available for 3D images)
reconDIM = '2D';
...
postproc.turnImage = false;
% correct frequency oversampling
postproc.FreqOversamplingCorr = false;
...
trafo.trafodim = [1 2 1 0 ;1 1 0 0 ];
...
measPara.dim = [200 200 1 1 8];
measPara.LCall = [1 1 1 1];
espresso.state = logical(0);
espresso.direction = 'off';
espresso.pfn = 1.000000;
measPara.dimension = '2D';
measPara.dim = [200 200 1 1 8];
measPara.LCall = [1 1 1 1];
espresso.state = logical(0);
