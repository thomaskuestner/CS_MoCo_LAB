...
disp('is appropriate for your system.  For pc-linux, the mex file is')
disp('called "dtft_mex.mexglx", which is provided in the "mfile"')
disp('subdirectory.  For a sun, the name is "dtft_mex.mexsol", which')
