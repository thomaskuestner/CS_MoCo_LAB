function kernel = calibrate3D(obj, AtA, nCha, coil)
% retrieve calibration kernel from 3D calibration region
%
% (c) Thomas Kuestner 
% ---------------------------------------------------------------------

sampling = ones([obj.kernelSize,nCha]);

dummyK = zeros([obj.kernelSize,nCha]); 
