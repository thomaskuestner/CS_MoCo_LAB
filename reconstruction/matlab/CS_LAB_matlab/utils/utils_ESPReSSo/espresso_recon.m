function [im, kspFull, smplPtrnSym, pfDim, phaseOut] = espresso_recon( ksp, iter, watchProgress, cs )
%ESPReSSo Reconstruction with POCS
%
...
%         end
    ...
    % TK
    if(nupf)
        [applDim,idx,idxBorder] = getCalibrationSize(ksp, smplPtrn, pfDim); % Ny x Nx x Nz
    else
